...
<body>
<center>
	<br><h3 style="color:white">재능 기부 프로젝트 list</h3><br><br>
	<table border="1">
		<tr>   
...
<br><font color="yellow">재능 기부자 id 및 재능 수혜자 id를 클릭하면 상세 정보 확인이 가능합니다</font>
&nbsp;&nbsp;&nbsp;<a href="index.html" style="color:white">닫기</a>
</center>
